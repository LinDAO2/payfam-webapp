...
import ManageMomoWithdrawListItem from "./ManageMomoWithdrawListItem";

const ManageMomoWithdrawList = () => {
...
export default ManageMomoWithdrawList;
