import ManageNGNWithdrawContainer from "@/components/mgt/manageNGNWithdraw/ManageNGNWithdrawContainer";
...
const ManageNGNWithdrawRequests = () => {
  ...
  return <ManageNGNWithdrawContainer />;
};

export default ManageNGNWithdrawRequests;
