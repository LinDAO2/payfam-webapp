...
import ManageMomoWithdrawContainer from "@/components/mgt/manageMomoWithdraw/ManageMomoWithdrawContainer";
...
const ManageMoMoWithdrawRequest = () => {
  ...
  return <ManageMomoWithdrawContainer />;
};

export default ManageMoMoWithdrawRequest;
